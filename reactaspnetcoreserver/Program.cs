...
using reactaspnetcoreserver.Data;
...
{
    swaggerGenOptions.SwaggerDoc("v1", new  OpenApiInfo { Title = "ASP.NET Testing with ReactJS", Version = "v1"});
});
...
{
    swaggerUIOptions.DocumentTitle = "ASP.NET Testing with ReactJS";
...
app.MapGet("/get-posts-by-id/{postId}", async (int postId) =>
{
